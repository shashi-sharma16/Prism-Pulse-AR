...
prism-pulse-ar/
├── index.html # App shell, HUD markup, settings drawer
├── package.json
└── src/
├── style.css # All visual styling
├── main.js # App entry point — wires camera, MediaPipe, render loop
├── sound.js # SoundEngine — Web Audio synth for hum + pulse feedback
├── poses.js # PoseAnalyzer — pinch/openness/two-hand gesture detection
└── visuals.js # VisualsEngine — particles, ripples, background layers
